...
public class NotificationWearableActionFragment extends Fragment {

    private EditText subjectEditText;
    private EditText contentEditText;
    private EditText searchTermEditText;

    public NotificationWearableActionFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_notification_wearable_action, container, false);
        ...
        sendNotificationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MainActivity.triggerNotification(getContext(), subjectEditText.getText().toString(), contentEditText.getText().toString(), true, action);
            }
        });
